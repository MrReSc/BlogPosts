...
Damit sicher keine Daten im Internet landen, habe ich auch das von Android angebotene automatische Backup `allowBackup` ab der Version `1.10.1-beta` deaktiviert.
